import { Ball, Models, balls, changeColour, changeModel } from '../src/bounce-balls.js';
...
test('test constructor', () => {
    ...
    expect(ball.speed).toBeGreaterThan(0.000);
    expect(ball.angle).toBeGreaterThanOrEqual(0.000);
    expect(ball.angle).toBeLessThanOrEqual(2.000 * Math.PI);
    ...
    expect(ball.energy).toBeGreaterThan(0.000);
});
